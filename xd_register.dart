    ...
    return Scaffold(
      ...
      body: Stack(
        children: <Widget>[
          ...
          Pinned.fromPins(
            Pin(start: 101.4, end: 304.2),
            Pin(start: 633.1, end: 274.3),
            child:
          ...
          Pinned.fromPins(
            Pin(start: 112.6, end: 293.0),
            Pin(start: 522.7, end: 384.7),
            child:
                // Adobe XD layer: 'Icon awesome-eye-sl…' (shape)
                SvgPicture.string(
              _svg_mt8q,
