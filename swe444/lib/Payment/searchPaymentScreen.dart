                ...
                child: IconButton(
                    ...
                    onPressed: () {
                      Navigator.pop(
                          context,
                          MaterialPageRoute(
                              builder: (context) => SearchRequests()));
                  ...
                  child: Directionality(
                    ...
                    child: TextFormField(
                      ...
                      validator: (value) {
                        ...
                        int check = SearchRequests.wholeAmount2 - SearchRequests.wholeDonated2;
...

                        {
                          ...
                          if (donated > SearchRequests.wholeAmount2 && check==SearchRequests.wholeAmount2)
                          ...
                          if(donated==SearchRequests.wholeAmount2 && check < SearchRequests.wholeAmount2 && check !=0)
              ...
              ElevatedButton(
                onPressed: () async {
                  if (_formKey.currentState!.validate()) {
                    ...
                    int amount1=((int.parse(_controller.text))* 100).toInt();
