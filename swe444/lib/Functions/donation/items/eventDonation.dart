...
class VieweventDonations extends StatefulWidget {
  VieweventDonations.ensureInitialized(this.document);
  final DocumentSnapshot document;

  const VieweventDonations({Key? key, required this.document}) : super(key: key);
...
class requestDonations extends State<VieweventDonations> {
//String
  @override
  void initState() {
    super.initState();
          ...
          builder: (context, snapshot) {
            ...
            return Container(
              ...
              child: Padding(
                ...
                child: Text("لا يوجد متبرعين حتى الآن"),
              ),
            );
          }),
    );
